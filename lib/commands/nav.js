...
if (!url) {
  console.log("Usage: cdp-browser nav <url> [--new]");
  console.log("\nExamples:");
  console.log("  cdp-browser nav https://example.com       # Navigate current tab");
  console.log("  cdp-browser nav https://example.com --new # Open in new tab");
  process.exit(1);
}
